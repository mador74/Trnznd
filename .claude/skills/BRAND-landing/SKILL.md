...
description: >-
  ...
  USE THIS SKILL whenever working on a product landing page â€” any request
...
The site should feel dark, cinematic, minimal, and premium â€” unless the brand
...
- `website/index.html` â€” all page section markup and Google Fonts link
- `website/src/main.js` â€” Lenis, ScrollTrigger, video scrub, section render logic
- `website/src/style.css` â€” base layout, typography, sections, video layer
- `website/src/glass.css` â€” glass panels, buttons, chips, cards
- `website/public/bg.mp4` â€” scroll-scrubbed all-keyframe background video
- `assets/references/BRAND-hero-reference.png` â€” main hero/product reference
- `assets/references/BRAND-material-reference.png` â€” material/detail reference
- `assets/references/BRAND-workspace-reference.png` â€” environment/mood reference
- `assets/videos/BRAND-scroll-background.mp4` â€” raw Higgsfield-generated video
- `copy/brand-kit.md` â€” product positioning, visual mood, site sections, video brief
...
structural reference only â€” replace every value with what the brand kit defines.
...
descriptions below are structural prompts â€” fill them in from the brand kit.
...
1. **Hero composition** â€” product on a surface appropriate to the brand's world.
   Keep one side calmer and darker for hero text and buttons.

2. **Material detail** â€” slow move into the product's surfaces, textures, and
   materials as described in the brand kit.

3. **Environment mood** â€” reveal the broader environment appropriate to the
...
as the primary section guide. The structure below is a generic default â€” follow
